...
/* harmony import */ var _modalInfo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modalInfo */ "./src/components/modalInfo.js");
...
var catalog = function catalog() {
  var firstHalfContainer = document.querySelector('.catalog__inner-1');
  var centerIndex = Math.round(data.length / 2);
  var firstHalf = data.slice(0, centerIndex);
  var secondHalf = data.slice(centerIndex, data.length);
  firstHalf.forEach(function (item, idx) {
    var node = getProductNode(item, idx);
    firstHalfContainer.appendChild(node);
  });
  var secondHalfContainer = document.querySelector('.catalog__inner-2');
  secondHalf.forEach(function (item, idx) {
    var node = getProductNode(item, idx + centerIndex);
    secondHalfContainer.appendChild(node);
  });
  initModalInfo();
};

var getProductNode = function getProductNode(item, idx) {
  var catalogItem = document.createElement('div');
  catalogItem.classList.add('catalog__item'); // Создание дочернего дива с изображением

  var catalogItemImg = document.createElement('div');
  var img = document.createElement('img');
  img.src = item.imageMain;
  catalogItemImg.appendChild(img);
  catalogItemImg.classList.add('catalog__item-img'); // Создание дочернего дива с текстом

  var catalogItemInfo = document.createElement('div'); // Создание во втором диве header с названием

  var catalogItemInfoHeader = document.createElement('div');
  catalogItemInfoHeader.classList.add('catalog__item-info-header');
  var catalogItemInfoHeaderP = document.createElement('p');
  catalogItemInfoHeaderP.textContent = item.title;
  catalogItemInfo.appendChild(catalogItemInfoHeader);
  catalogItemInfoHeader.appendChild(catalogItemInfoHeaderP); // Создание во втором диве text с ифной времени

  var catalogItemInfoTime = document.createElement('div');
  catalogItemInfoTime.classList.add('catalog__item-info-text');
  var catalogItemInfoTimeP = document.createElement('p');
  catalogItemInfoTimeP.textContent = item.infoTime;
  catalogItemInfo.appendChild(catalogItemInfoTime);
  catalogItemInfoTime.appendChild(catalogItemInfoTimeP); // Создание во втором диве text с ифной прайса

  var catalogItemInfoPrice = document.createElement('div');
  catalogItemInfoPrice.classList.add('catalog__item-info-text');
  var catalogItemInfoPriceP = document.createElement('p');
  ...
  catalogItemInfo.classList.add('catalog__item-info'); // Создание дочернего дива с кнопкой
  ...
  catalogItemButton.classList.add('catalog__item-button'); // Добавление всех трех элементов в родительский элемент
...
var initModalInfo = function initModalInfo() {
  var modal = document.getElementById('modal-buy');
  var modalBtns = document.querySelectorAll('[data-modal-buy]');
  var modalInfoBtn = document.getElementById('modal-info-btn-calculate');
  var modalInstance = new bootstrap__WEBPACK_IMPORTED_MODULE_3__.Modal(modal);
  var modalChilds = {
  ...
  modalBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var productId = btn.getAttribute('data-modal-buy');
      ...
      if (product) {
        ...
        var handleModalInfoBtnClick = function handleModalInfoBtnClick(e) {
          e.preventDefault();
          modalInstance.hide();
          (0,_modalInfo__WEBPACK_IMPORTED_MODULE_4__.showModalInfo)({
            title: "\u041E\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u0437\u0430\u044F\u0432\u043A\u0443<br>\u043D\u0430 \u043F\u043E\u0434\u0440\u043E\u0431\u043D\u044B\u0439 \u043F\u0440\u043E\u0441\u0447\u0435\u0442<br><b>\"".concat(product.title, "\"</b>")
          });
...
var fillModalBody = function fillModalBody(product, modal) {
  ...
  if (!product.fillingDoorsglass) {
    product.fillingDoorsglass = "";
  }
  ...
  if (!product.imgOtherSecond) {
    modal.imgOtherSecond.style.display = "none";
  } else {
    modal.imgOtherSecond.src = product.imgOtherSecond;
  }

  ;

  if (!product.imgOtherThird) {
    modal.imgOtherThird.style.display = "none";
  } else {
    modal.imgOtherThird.src = product.imgOtherThird;
  }

  ;

  if (!product.imgOtherFourth) {
    modal.imgOtherFourth.style.display = "none";
  } else {
    modal.imgOtherFourth.src = product.imgOtherFourth;
  }

  ;
  modal.title.textContent = product.title;
  modal.info.innerHTML = "".concat(product.infoTime, " </br> ").concat(product.infoPrice, " </br> ").concat(product.width, " </br> ").concat(product.height, " </br> ").concat(product.depth, " </br> ").concat(product.material, " </br> ").concat(product.fillingDoorsglass, " </br> ").concat(product.profile);
...
var imageGallery = function imageGallery() {
  var displayedImage = document.querySelector('.modal-body__image-main img');
  var thumbBar = document.querySelector('.modal-body__image-other');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _imageGallery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./imageGallery */ "./src/components/imageGallery.js");
...
/* harmony import */ var _modalInfo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modalInfo */ "./src/components/modalInfo.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return document.addEventListener('DOMContentLoaded', function () {
    ...
    (0,_catalog__WEBPACK_IMPORTED_MODULE_1__.catalog)();
    (0,_imageGallery__WEBPACK_IMPORTED_MODULE_0__.imageGallery)();
    (0,_modalInfo__WEBPACK_IMPORTED_MODULE_3__.initModalInfo)();
  });
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initModalInfo": function() { return /* binding */ initModalInfo; },
/* harmony export */   "showModalInfo": function() { return /* binding */ showModalInfo; }
/* harmony export */ });
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");

var modalInfo;
var modalInfoTitle;
var modalInfoInstance;
var defaultModalInfoHTML;
var initModalInfo = function initModalInfo() {
  modalInfo = document.getElementById('modal-info');
  modalInfoTitle = modalInfo.querySelector('.modal-title');
  modalInfoInstance = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(modalInfo);
  defaultModalInfoHTML = modalInfoTitle.innerHTML;
};
var showModalInfo = function showModalInfo(options) {
  if (options) {
  ...
  var handleSetTitleToDefault = function handleSetTitleToDefault() {
...
var slider = function slider() {
  return $(document).ready(function () {
    $('.feedback__carusel').slick({
      dots: false,
      infinite: true,
      nextArrow: '<button class="arrow-arrow arrow-right"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>',
      prevArrow: '<button class="arrow-arrow arrow-left"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>'
    });
  });
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fonts_FuturaPT_FuturaPT_Light_ttf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-Light.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-Light.ttf");
/* harmony import */ var _fonts_FuturaPT_FuturaPT_Book_ttf__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-Book.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-Book.ttf");
/* harmony import */ var _fonts_FuturaPT_FuturaPT_Medium_ttf__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-Medium.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-Medium.ttf");
/* harmony import */ var _fonts_FuturaPT_FuturaPT_Demi_ttf__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-Demi.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-Demi.ttf");
/* harmony import */ var _fonts_FuturaPT_FuturaPT_Bold_ttf__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-Bold.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-Bold.ttf");
/* harmony import */ var _fonts_FuturaPT_FuturaPT_ExtraBold_ttf__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-ExtraBold.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-ExtraBold.ttf");
/* harmony import */ var _fonts_FuturaPT_FuturaPT_Heavy_ttf__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./fonts/FuturaPT/FuturaPT-Heavy.ttf */ "./src/styles/fonts/FuturaPT/FuturaPT-Heavy.ttf");
...
/***/ "./src/styles/fonts/FuturaPT/FuturaPT-Bold.ttf":
/*!*****************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-Bold.ttf ***!
  \*****************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-Bold.ttf";

/***/ }),

/***/ "./src/styles/fonts/FuturaPT/FuturaPT-Book.ttf":
/*!*****************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-Book.ttf ***!
  \*****************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-Book.ttf";

/***/ }),

/***/ "./src/styles/fonts/FuturaPT/FuturaPT-Demi.ttf":
/*!*****************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-Demi.ttf ***!
  \*****************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-Demi.ttf";

/***/ }),

/***/ "./src/styles/fonts/FuturaPT/FuturaPT-ExtraBold.ttf":
/*!**********************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-ExtraBold.ttf ***!
  \**********************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-ExtraBold.ttf";

/***/ }),

/***/ "./src/styles/fonts/FuturaPT/FuturaPT-Heavy.ttf":
/*!******************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-Heavy.ttf ***!
  \******************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-Heavy.ttf";

/***/ }),

/***/ "./src/styles/fonts/FuturaPT/FuturaPT-Light.ttf":
/*!******************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-Light.ttf ***!
  \******************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-Light.ttf";

/***/ }),

/***/ "./src/styles/fonts/FuturaPT/FuturaPT-Medium.ttf":
/*!*******************************************************!*\
  !*** ./src/styles/fonts/FuturaPT/FuturaPT-Medium.ttf ***!
  \*******************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/FuturaPT-Medium.ttf";
...
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! slick-carousel */ "./node_modules/slick-carousel/slick/slick.js");
...
/* harmony import */ var _styles_fonts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./styles/_fonts */ "./src/styles/_fonts.js");
...
(0,_components__WEBPACK_IMPORTED_MODULE_14__.default)();
}();
/******/ })()
;
